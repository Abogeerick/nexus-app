  ...
  for (let i = 0; i < numTransactions; i++) {
    ...
    if (transactionType < 0.15) {
      ...
      transaction = {
        ...
        transactionDate,
        timestamp: BigInt(transactionDate.getTime()),
        type: merchant.includes("UBER") || merchant.includes("BOLT") ? "PAYBILL" : "BUY_GOODS",
        category: "Transport",
        isIncome: false,
        counterpartyName: merchant,
        counterpartyPhone: null,
      ...
      transaction = {
        ...
        transactionDate,
        timestamp: BigInt(transactionDate.getTime()),
        type: merchant.includes("SAFARICOM") ? "AIRTIME_PURCHASE" : "PAYBILL",
        category: "Utilities",
        isIncome: false,
        counterpartyName: merchant,
        counterpartyPhone: null,
      ...
      transaction = {
        ...
        transactionDate,
        timestamp: BigInt(transactionDate.getTime()),
        type: isLoan ? "FULIZA_LOAN" : "FULIZA_REPAYMENT",
        category: "Financial",
        isIncome: isLoan,
